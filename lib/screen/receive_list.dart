...
import '../presenter/receive_list_presenter.dart';
...
class _ReceiveListState extends State<ReceiveList> implements ReceiveListView {
  ReceiveListPresenter? _presenter;
  ...
  List<ReceiveData> list = [];

  FilterData? filterData;

  _ReceiveListState() {
    _presenter = ReceiveListPresenter(this);
  }
  ...
  void initState() {
    ...
    _presenter!.getReceiveList(filterData!.id!, page, '');

    _scrollController.addListener(() {
      if (_scrollController.position.maxScrollExtent == _scrollController.position.pixels) {
        page++;
        _presenter!.getReceiveList(filterData!.id!, page, search);
        print('call api');
      }
    });
  }
      ...
      child: SafeArea(
        child: Scaffold(
          ...
          floatingActionButton: FloatingActionButton(
            onPressed: () async {
              var data = await Get.toNamed('/add_receive_entry', arguments: [filterData]);
              if (data != null) {
                if (data) {
                  page = 0;
                  search = '';
  ...
  Widget listCell(ReceiveData data, int i) {
    return Column(
      children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Visibility(
                      ...
                      child: InkWell(
                          onTap: (() async {
                            var rData = await Get.toNamed('/add_receive_entry', arguments: [filterData, data]);
                          }),
                    ...
                    Visibility(
                      ...
                      child: InkWell(
                          onTap: (() async {
                            deletePosition = i;
                            //deleteDialog(context, data.inwardTrnId!, data.typeId!, 'Receive Entry');
                            customConfirmationDialog(context, "Confirmation...!",
                                "Are you sure you want to delete this order?", "Yes", "No", () {
                              _presenter!.deleteReceive(data.inwardTrnId!, data.typeId!, 'Receive Entry');
                            });
                          }),
                          child: iconWidget(const Color(0xFFF44336), icDeleteFill)),
                    ),
                    horizontalViewSmall(),
                    Visibility(
                          ...
                          onTap: (() async {
                            ...
                            if (data.report!.length > 0) {
                              if (data.report!.length == 1) {
                                openReport(data.inwardTrnId.toString(), data.report![0].id!, data.report![0].name!);
                              } else {
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    verticalView(),
                    Visibility(
                      visible: data.receiveItemDetails != null && data.receiveItemDetails!.length > 0,
                      child: Column(
                        children: [
                          Row(
                            children: [
                              ...
                              Visibility(
                                visible: data.receiveItemDetails!.length > 1,
                                child: InkWell(
                                  onTap: (() {
                                    setState(() {
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        border: Border.all(color: colorAppLite, width: 0.5),
                          ...
                          Container(
                              ...
                              child: ListView.builder(
                                  ...
                                  itemCount: data.isShow ? data.receiveItemDetails!.length : 1,
                                  itemBuilder: (BuildContext context, i) {
                                    var iidData = data.receiveItemDetails![i];
                                    return Column(
                                      children: [
                                        Padding(
                                          padding: const EdgeInsets.all(10),
                                              ...
                                              Visibility(
                                                ...
                                                child: Padding(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      itemDetailsView(
                                                          'Taka No. : ${iidData.suffix!}${iidData.takaNo!.toString()}'),
                                        ...
                                        Visibility(
                                            visible: (data.receiveItemDetails!.length - 1) != i,
  ...
  bottomSheetPrintDialog(ReceiveData d) {
                ...
                ListView.builder(
                    ...
                    itemBuilder: (BuildContext context, i) {
                      ...
                      return InkWell(
                        onTap: (() {
                          Get.back();
                          openReport(d.inwardTrnId!.toString(), issueData.id!, issueData.name!);
                        }),
                        child: Column(
                          children: [
                            Padding(
          ...
          return AlertDialog(
            ...
            actions: <Widget>[
              ...
              TextButton(
                ...
                onPressed: () {
                  Navigator.of(context).pop();
                  _presenter!.deleteReceive(id, serId, mode);
                },
              )
            ],
          );
