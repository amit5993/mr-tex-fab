...
class _ApprovalState extends State<Approval> implements FilterView {
              ...
              itemBuilder: (BuildContext context, i) {
                ...
                return InkWell(
                  onTap: (() {
                    ...
                    Get.toNamed('/approval_pending_list', arguments: data);
  ...
  void onGetFilterSuccess(FilterResponse data) {
    ...
    if (data.success!) {
      ...
      setState(() {
        if(list.length == 1){
          Get.toNamed('/approval_pending_list', arguments: list[0]);
        }
      });
    } else {
      page--;
